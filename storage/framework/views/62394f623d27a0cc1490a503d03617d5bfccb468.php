...
<body>
    ...
    <div class="report-container">
        ...
        <div class="report-header">
            <div><strong><?php echo e($shopdatas[0]->company ?? 'Company Name'); ?></strong></div>
            <div><?php echo e($shopdatas[0]->location ?? 'Location'); ?> | <?php echo e($shopdatas[0]->mobile ?? 'Phone Number'); ?></div>
            <div class="report-title">JOURNAL ENTRY</div>
            <div>As of <?php echo e(\Carbon\Carbon::now()->format('d M Y')); ?></div>
        </div>
        ...
        <div class="filter-section">
            <form method="GET" action="<?php echo e(url()->current()); ?>" id="filterForm">
                <input type="hidden" name="tab" id="activeTab" value="<?php echo e(request('tab', 'manual')); ?>">
                <div class="row" style="margin-bottom: 5px;">
                    <div class="col-md-2"><label>From Date</label><input type="date" name="start_date" class="form-control" value="<?php echo e(request('start_date')); ?>"></div>
                    <div class="col-md-2"><label>To Date</label><input type="date" name="end_date" class="form-control" value="<?php echo e(request('end_date')); ?>"></div>
                    <div class="col-md-2"><label>Entity</label><input type="text" name="entity" class="form-control" value="<?php echo e(request('entity')); ?>" placeholder="e.g. Supplier"></div>
                    <div class="col-md-2"><label>Reference</label><input type="text" name="reference" class="form-control" value="<?php echo e(request('reference')); ?>"></div>
                    <div class="col-md-2">
                        <label>Method</label>
                        <select name="paid_through" class="form-control">
                            <option value="">-- Select --</option>
                            <option value="Bank" <?php echo e(request('paid_through') == 'Bank' ? 'selected' : ''); ?>>Bank</option>
                            <option value="Cheque" <?php echo e(request('paid_through') == 'Cheque' ? 'selected' : ''); ?>>Cheque</option>
                            <option value="Card" <?php echo e(request('paid_through') == 'Card' ? 'selected' : ''); ?>>Card</option>
                        </select>
                    </div>
        ...
        <ul class="nav nav-tabs" role="tablist">
            <li role="presentation" class="<?php echo e(request('tab', 'manual') == 'manual' ? 'active' : ''); ?>">
                <a href="#manual" aria-controls="manual" role="tab" data-toggle="tab">
                    Manual Entry
                </a>
            </li>
            <li role="presentation" class="<?php echo e(request('tab') == 'listing' ? 'active' : ''); ?>">
                <a href="#listing" aria-controls="listing" role="tab" data-toggle="tab">
                    Listing View
                </a>
            </li>
            <li role="presentation" class="<?php echo e(request('tab') == 'book' ? 'active' : ''); ?>">
        ...
        <div class="tab-content" style="margin-top:20px;">
            ...
            <div role="tabpanel" class="tab-pane fade <?php echo e(request('tab', 'manual') == 'manual' ? 'in active' : ''); ?>" id="manual">
                
                <form action="<?php echo e(route('journalentry.save')); ?>" method="POST" id="journalForm">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            ...
                            <tbody id="journal-entry-body">
                                <?php $rowIndex = 0; ?>
                                <?php if(old('entries')): ?>
                                    <?php $__currentLoopData = old('entries'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $entry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td class="td-relative">
                                                <input type="date" name="entries[<?php echo e($index); ?>][entry_date]" value="<?php echo e($entry['entry_date']); ?>" required class="form-control">
                                                <?php if($errors->has("entries.$index.entry_date")): ?>
                                                    <div class="error-message"><?php echo e($errors->first("entries.$index.entry_date")); ?></div>
                                                <?php endif; ?>
                                            </td>
                                            <td class="td-relative">
                                                <select name="entries[<?php echo e($index); ?>][entity]" class="form-control <?php echo e($errors->has("entries.$index.entity") ? 'error' : ''); ?>" onchange="toggleEntityOther(this)">
                                                    ...
                                                    <?php $__currentLoopData = $entities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $entity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($entity); ?>" <?php echo e($entry['entity'] == $entity ? 'selected' : ''); ?>><?php echo e($entity); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="Other" <?php echo e($entry['entity'] == 'Other' ? 'selected' : ''); ?>>Other</option>
                                                </select>
                                                <input type="text" name="entries[<?php echo e($index); ?>][entity_other]" value="<?php echo e($entry['entity_other'] ?? ''); ?>" class="form-control entity-other-input <?php echo e($errors->has("entries.$index.entity_other") ? 'error' : ''); ?>" placeholder="Enter Entity" <?php echo e($entry['entity'] == 'Other' ? 'required' : ''); ?>>
                                                <?php if($errors->has("entries.$index.entity")): ?>
                                                    <div class="error-message"><?php echo e($errors->first("entries.$index.entity")); ?></div>
                                                <?php endif; ?>
                                            </td>
                                            <td class="td-relative">
                                                <select name="entries[<?php echo e($index); ?>][account]" class="form-control <?php echo e($errors->has("entries.$index.account") ? 'error' : ''); ?>" required onchange="toggleAccountOther(this)">
                                                    <option value="">-- Select Account --</option>
                                                    <?php $__currentLoopData = $accounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $account): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($account); ?>" <?php echo e($entry['account'] == $account ? 'selected' : ''); ?>><?php echo e($account); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="Other" <?php echo e($entry['account'] == 'Other' ? 'selected' : ''); ?>>Other</option>
                                                </select>
                                                <input type="text" name="entries[<?php echo e($index); ?>][account_other]" value="<?php echo e($entry['account_other'] ?? ''); ?>" class="form-control account-other-input <?php echo e($errors->has("entries.$index.account_other") ? 'error' : ''); ?>" placeholder="Enter Account" <?php echo e($entry['account'] == 'Other' ? 'required' : ''); ?>>
                                                <?php if($errors->has("entries.$index.account")): ?>
                                                    <div class="error-message"><?php echo e($errors->first("entries.$index.account")); ?></div>
                                                <?php endif; ?>
                                            </td>
                                            <td><input type="text" name="entries[<?php echo e($index); ?>][description]" value="<?php echo e($entry['description'] ?? ''); ?>" class="form-control"></td>
                                            <td>
                                                <select name="entries[<?php echo e($index); ?>][paid_through]" class="form-control">
                                                    <option value="">-- Select --</option>
                                                    <option value="Bank" <?php echo e($entry['paid_through'] == 'Bank' ? 'selected' : ''); ?>>Bank</option>
                                                    <option value="Cheque" <?php echo e($entry['paid_through'] == 'Cheque' ? 'selected' : ''); ?>>Cheque</option>
                                                    <option value="Card" <?php echo e($entry['paid_through'] == 'Card' ? 'selected' : ''); ?>>Card</option>
                                                </select>
                                            </td>
                                            <td><input type="text" name="entries[<?php echo e($index); ?>][reference]" value="<?php echo e($entry['reference'] ?? ''); ?>" class="form-control"></td>
                                            <td class="td-relative">
                                                <input type="number" name="entries[<?php echo e($index); ?>][debit]" value="<?php echo e($entry['debit'] ?? ''); ?>" step="0.01" class="form-control amount-input" oninput="updateRowTotal(this)" placeholder="0.00">
                                                <?php if($errors->has("entries.$index.debit")): ?>
                                                    <div class="error-message"><?php echo e($errors->first("entries.$index.debit")); ?></div>
                                                <?php endif; ?>
                                            </td>
                                            <td class="td-relative">
                                                <input type="number" name="entries[<?php echo e($index); ?>][credit]" value="<?php echo e($entry['credit'] ?? ''); ?>" step="0.01" class="form-control amount-input" oninput="updateRowTotal(this)" placeholder="0.00">
                                                <?php if($errors->has("entries.$index.credit")): ?>
                                                    <div class="error-message"><?php echo e($errors->first("entries.$index.credit")); ?></div>
                                                <?php endif; ?>
                                            </td>
                                            <td>
                                ...
                                <?php else: ?>
                                    <tr>
                                        <td class="td-relative">
                                            <input type="date" name="entries[0][entry_date]" required class="form-control" value="<?php echo e(date('Y-m-d')); ?>">
                                        </td>
                                        <td class="td-relative">
                ...
                <div role="tabpanel" class="tab-pane fade <?php echo e(request('tab') == 'listing' ? 'in active' : ''); ?>" id="listing">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <?php $__empty_1 = true; $__currentLoopData = $journalEntries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $entry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        <td class="slno"><?php echo e($sl++); ?></td>
                                        <td class="date"><?php echo e(\Carbon\Carbon::parse($entry->entry_date)->format('d-m-Y')); ?></td>
                                        <td class="entity"><?php echo e($entry->entity); ?></td>
                                        <td class="account"><?php echo e($entry->account); ?></td>
                                        <td class="description"><?php echo e($entry->description); ?></td>
                                        <td class="method"><?php echo e($entry->paid_through); ?></td>
                                        <td class="reference"><?php echo e($entry->reference); ?></td>
                                        <td class="debit"><?php echo e($currency); ?> <?php echo e(number_format($entry->debit, 2)); ?></td>
                                        <td class="credit"><?php echo e($currency); ?> <?php echo e(number_format($entry->credit, 2)); ?></td>
                                        </tr>
                            ...
                            <tfoot>
                                <tr style="background: #e8f4f2;">
                                    ...
                                    <td class="debit"><?php echo e($currency); ?> <?php echo e(number_format($totalDebit, 2)); ?></td>
                                    <td class="credit"><?php echo e($currency); ?> <?php echo e(number_format($totalCredit, 2)); ?></td>
                                </tr>
                                <tr style="background: #e8f4f2;">
                                    <td colspan="7" class="text-right">Balance</td>
                                    <td colspan="2" class="text-center <?php echo e($totalDebit == $totalCredit ? 'text-success' : 'text-danger'); ?>">
                                        <?php echo e($currency); ?> <?php echo e(number_format(abs($totalDebit - $totalCredit), 2)); ?> 
                                        <?php echo e($totalDebit > $totalCredit ? 'Debit' : ($totalDebit < $totalCredit ? 'Credit' : 'Balanced')); ?>
                    ...
                    <div class="pagination-container">
                        <button onclick="goToPage(1)" class="page-btn <?php echo e($journalEntries->currentPage() == 1 ? 'disabled' : ''); ?>" title="First Page">
                            &laquo;&laquo;
                        </button>
                        <button onclick="goToPage(<?php echo e($journalEntries->currentPage() - 1); ?>)" class="page-btn <?php echo e($journalEntries->currentPage() == 1 ? 'disabled' : ''); ?>" title="Previous Page">
                            &laquo;
                        </button>
                        ...
                        <div class="page-info">
                            ...
                            <input type="number" class="page-input-box" id="pageInput" 
                                   min="1" max="<?php echo e($journalEntries->lastPage()); ?>" 
                                   value="<?php echo e($journalEntries->currentPage()); ?>">
                            <span>of <?php echo e($journalEntries->lastPage()); ?></span>
                            <button class="go-to-page" onclick="goToPage()">Go</button>
                        </div>
                        
                        <button onclick="goToPage(<?php echo e($journalEntries->currentPage() + 1); ?>)" class="page-btn <?php echo e($journalEntries->currentPage() == $journalEntries->lastPage() ? 'disabled' : ''); ?>" title="Next Page">
                            &raquo;
                        </button>
                        <button onclick="goToPage(<?php echo e($journalEntries->lastPage()); ?>)" class="page-btn <?php echo e($journalEntries->currentPage() == $journalEntries->lastPage() ? 'disabled' : ''); ?>" title="Last Page">
                            &laquo;&laquo;
                        </button>
                    </div>
                </div>
                ...
                <div role="tabpanel" class="tab-pane fade <?php echo e(request('tab') == 'book' ? 'in active' : ''); ?>" id="book">
...
$groupedEntries[$key][] = $entry;
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $paginatedGroups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transactionRef => $entries): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <?php 
                        ...
                        <div class="transaction-header">
                            <span class="transaction-type-badge transaction-<?php echo e(strtolower($transactionType)); ?>"><?php echo e($transactionType); ?></span>
                            <?php if($transactionRef != $entries[0]->entry_date): ?> - Ref: <?php echo e($transactionRef); ?> <?php endif; ?>
                        </div>
                        ...
                        <table class="journal-book-table">
                            <thead>
                                <tr>
                                    ...
                                    <th class="amount-col">Debit (<?php echo e($currency); ?>)</th>
                                    <th class="amount-col">Credit (<?php echo e($currency); ?>)</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    <td class="date-col"><?php echo e($date); ?></td>
                                    <td class="particulars-col">
                                        <div class="journal-entry-particulars">
                                            <?php $__currentLoopData = $entries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $entry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php if($entry->debit > 0): ?>
                                                    <div class="debit-line"><?php echo e($entry->account); ?> A/c Dr.</div>
                                                    <?php $totalDebit += $entry->debit; ?>
                                                <?php endif; ?>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            <?php $__currentLoopData = $entries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $entry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php if($entry->credit > 0): ?>
                                                    <div class="credit-line">To <?php echo e($entry->account); ?> A/c</div>
                                                    <?php $totalCredit += $entry->credit; ?>
                                                <?php endif; ?>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            <div class="journal-entry-narration">
                                                (<?php echo e(optional($entries[0]->transaction)->narration ?? ($entries[0]->description ?: 'Being transaction recorded')); ?>)
                                            </div>
                                        </div>
                                    </td>
                                    <td class="amount-col">
                                        <?php $__currentLoopData = $entries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $entry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if($entry->debit > 0): ?>
                                                <?php echo e(number_format($entry->debit, 2)); ?><br>
                                            <?php endif; ?>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </td>
                                    <td class="amount-col">
                                        <?php $__currentLoopData = $entries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $entry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if($entry->credit > 0): ?>
                                                <?php echo e(number_format($entry->credit, 2)); ?><br>
                                            <?php endif; ?>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </td>
                                </tr>
                    ...
                    <table class="journal-book-table">
                        ...
                        <tbody>
                            <tr class="running-balance">
                                ...
                                <td class="text-right"><?php echo e($currency); ?> <?php echo e(number_format($totalDebit, 2)); ?></td>
                            </tr>
                            <tr class="running-balance">
                                <td class="text-right">Total Credit:</td>
                                <td class="text-right"><?php echo e($currency); ?> <?php echo e(number_format($totalCredit, 2)); ?></td>
                            </tr>
                            <tr class="running-balance">
                                <td class="text-right">Balance:</td>
                                <td class="text-right"><?php echo e($currency); ?> <?php echo e(number_format(abs($totalDebit - $totalCredit), 2)); ?></td>
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <div class="pagination-container">
                        <button onclick="goToBookPage(1)" class="page-btn <?php echo e($currentBookPage == 1 ? 'disabled' : ''); ?>" title="First Page">
                            &laquo;&laquo;
                        </button>
                        <button onclick="goToBookPage(<?php echo e($currentBookPage - 1); ?>)" class="page-btn <?php echo e($currentBookPage == 1 ? 'disabled' : ''); ?>" title="Previous Page">
                            &laquo;
                        </button>
                        ...
                        <div class="page-info">
                            ...
                            <input type="number" class="page-input-box" id="bookPageInput" 
                                   min="1" max="<?php echo e($lastBookPage); ?>" 
                                   value="<?php echo e($currentBookPage); ?>">
                            <span>of <?php echo e($lastBookPage); ?></span>
                            <button class="go-to-page" onclick="goToBookPage()">Go</button>
                        </div>
                        
                        <button onclick="goToBookPage(<?php echo e($currentBookPage + 1); ?>)" class="page-btn <?php echo e($currentBookPage == $lastBookPage ? 'disabled' : ''); ?>" title="Next Page">
                            &raquo;
                        </button>
                        <button onclick="goToBookPage(<?php echo e($lastBookPage); ?>)" class="page-btn <?php echo e($currentBookPage == $lastBookPage ? 'disabled' : ''); ?>" title="Last Page">
                            &raquo;&raquo;
                        </button>
                    </div>
                </div>
    ...
    let rowIndex = <?php echo e(old('entries') ? count(old('entries')) : 1); ?>;
    ...
    function createNewRow(index) {
        return `
            <tr>
                <td class="td-relative">
                    <input type="date" name="entries[${index}][entry_date]" required class="form-control" value="<?php echo e(date('Y-m-d')); ?>">
                </td>
                <td class="td-relative">
    ...
    function goToPage(page = null) {
        if (!page) {
            ...
            page = Math.max(1, Math.min(page, <?php echo e($journalEntries->lastPage()); ?>));
        }
    ...
    function goToBookPage(page = null) {
        if (!page) {
            ...
            if (isNaN(page)) return;
            page = Math.max(1, Math.min(page, <?php echo e($lastBookPage ?? 1); ?>));
        }
...
</html><?php /**PATH C:\xampp\htdocs\netplex_26_7\resources\views/chartaccounts/journalentry.blade.php ENDPATH**/ ?>