...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="input-group" style="margin-bottom: 15px;">
                        ...
                        <input type="text" class="form-control branchname" name="branchname"  id="branchname"
                            placeholder="Enter the branch name" value="<?php echo e(old('branchname')); ?>">
                        <span style="color:red">
                            <?php $__errorArgs = ['branchname'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="input-group" style="margin-bottom: 15px;">
                        ...
                        <input type="text" class="form-control" name="transaction_id" id="transaction_id"
                            placeholder="Enter the Transaction id" value="<?php echo e(old('transaction_id')); ?>" required>
...
</script><?php /**PATH C:\xampp\htdocs\netplex_26_7\resources\views//admin/createbranch.blade.php ENDPATH**/ ?>