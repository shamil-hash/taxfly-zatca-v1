                ...
                <div class="modal-body">
                    <div class="report-category">
                        ...
                        <div class="report-options">
                            <a href="/export-sales-day/<?php echo e($userid); ?>/1/<?php echo e($location); ?>/<?php echo e($todayDate); ?>" class="report-option">
                                <i class="glyphicon glyphicon-calendar"></i> Today's Sales
                            </a>
                            <a href="/export-sales-month/<?php echo e($userid); ?>/2/<?php echo e($location); ?>/<?php echo e($monthid); ?>" class="report-option">
                                <i class="glyphicon glyphicon-stats"></i> Monthly Sales
                            </a>
                            <a href="/export-sales-year/<?php echo e($userid); ?>/3/<?php echo e($location); ?>/<?php echo e($currentYear); ?>" class="report-option">
                    ...
                    <div class="report-category">
                        ...
                        <div class="report-options">
                            <a href="/export-purchase-day/<?php echo e($userid); ?>/1/<?php echo e($location); ?>/<?php echo e($todayDate); ?>" class="report-option">
                                <i class="glyphicon glyphicon-shopping-cart"></i> Today's Purchases
                            </a>
                            <a href="/export-purchase-month/<?php echo e($userid); ?>/2/<?php echo e($location); ?>/<?php echo e($monthid); ?>" class="report-option">
                                <i class="glyphicon glyphicon-list-alt"></i> Monthly Purchases
                            </a>
                            <a href="/export-purchase-year/<?php echo e($userid); ?>/3/<?php echo e($location); ?>/<?php echo e($currentYear); ?>" class="report-option">
                    ...
                    <div class="report-category">
                        ...
                        <div class="report-options">
                            <a href="<?php echo e(route('exportproductreport')); ?>" class="report-option">
                                <i class="glyphicon glyphicon-export"></i> Export Product Report
                            </a>
                            <a href="<?php echo e(url('export-product')); ?>" class="report-option">
                                <i class="glyphicon glyphicon-export"></i> Export Products
                            </a>
                            <a href="<?php echo e(route('printstocklist')); ?>" class="report-option">
                                <i class="glyphicon glyphicon-export"></i> Export Stock
                            </a>
                            <a href="<?php echo e(url('/export-expense-history')); ?>" class="report-option">
                            ...
                            ?>
                            <a href="/exportpandl/<?php echo e($start_date); ?>/<?php echo e($end_date); ?>/<?php echo e($location); ?>" class="report-option">
                        ...
                        <div class="performance-list">
                            ...
                            <div class="performance-item">
                                ...
                                <!-- <span class="high-performer">
                                    <?php echo e($currency); ?> <?php echo e(number_format($customer->transaction_count, 2)); ?>
                            ...
                            <div>
                                ...
                                <div class="performance-list" id="topProducts">
                                    ...
                                    <div class="performance-item">
                                        ...
                                        <span class="high-performer">
                                            <?php echo e(number_format($product->total_sales, 2)); ?> 
                                        </span>
                                    </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
...
<script>
    ...
    </script><?php /**PATH C:\xampp\htdocs\netplex_26_7\resources\views//admin/admindashboard.blade.php ENDPATH**/ ?>