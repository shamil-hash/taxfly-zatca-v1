...
<div style="display: flex; width: 100%; background-color: #f8f9fa; padding: 5px; border-radius: 6px;" role="group" aria-label="Report navigation">
  ...
  <div style="flex: 1; margin: 0 3px;">
    ...
    <div class="input-group" style="margin-bottom: 10px;">
      <a href="/export-purchase-yearsdata/{{$userid}}/{{$viewtype}}/{{$location}}/{{$fromdate}}/{{$todate}}" class="btn btn-primary">Export</a>
    </div>
    <table>
      <tr>
            <th>Date</th>
      ...
      <tr>
        ...
        <td>
          <a href="/yearpurchases/{{$purchase->date}}/{{$location}}" class="btn btn-primary">VIEW</a>

          <div class="input-group export">
            <a href="/export-purchase-year/{{$userid}}/{{$viewtype}}/{{$location}}/{{$purchase->date}}" class="btn btn-primary">Excel</a>
          </div>
        </td>
      </tr>
      @endforeach
