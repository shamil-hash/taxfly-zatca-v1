...
<body>
  ...
  <div style="flex: 1; margin: 0 3px;">
    ...
    <div class="input-group" style="margin-bottom: 10px;">
      <a href="/export-purchasereturn-yearsdata/{{$userid}}/{{$viewtype}}/{{$location}}/{{$fromdate}}/{{$todate}}" class="btn btn-primary">Export</a>
    </div>
    <table>
      <tr>
        <th>Date</th>
      ...
      <tr>
        ...
        <td>
          <a href="/yearpurchasesreturn/{{$purchase->date}}/{{$location}}" class="btn btn-primary">VIEW</a>

          <div class="input-group export">
            <a href="/export-purchasereturn-year/{{$userid}}/{{$viewtype}}/{{$location}}/{{$purchase->date}}" class="btn btn-primary">Export</a>
          </div>
        </td>
      </tr>
      @endforeach
