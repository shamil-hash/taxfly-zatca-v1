  ...
  <div id="content">
    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Monthly Expenses</li>
      </ol>
    </nav>
    <div class="btn-group btn-group-justified" role="group" aria-label="...">
      <div class="btn-group" role="group">
        <a href="" class="btn btn-primary active">Monthly Expenses</a>
      </div>
      <div class="btn-group" role="group">
    ...
    <form action="companyexpensessubmit" method="POST" enctype="multipart/form-data" id="companyexpenseform" onsubmit="return validateForm();">
      @csrf
      <h2 ALIGN="CENTER">Monthly Expenses </h2>
      @csrf
      <div class="row">
