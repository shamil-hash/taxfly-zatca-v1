    ...
    <div id="content">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active" aria-current="page">Capital History</li>
            </ol>
          </nav>
          <div class="dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                <a href="/chartaccounts" class="dropdown-item ">Add Capital</a>
                        ...
                        <tbody>
                            @foreach ($capitals as $capital)
                                <tr>
                                    ...
                                    <td>{{ $capital->sub_type }}</td>
                                    <td>{{ $capital->type_category }}</td>
                                    <td>{{ $capital->type_name }}</td>
                                    <td>{{ $capital->type_amount }}</td>
                                    <td>{{ $capital->type_details }}</td>
                                    <td>{{ $capital->type_date }}</td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
