                ...
                <table class="financial-table">
                    <thead>
                        <tr>
                            ...
                            <th class="debit-col">Debit ({{ $currency }})</th>
                            <th class="credit-col">Credit ({{ $currency }})</th>
                        </tr>
                    </thead>
                    <tbody>
                        <!-- ASSETS SECTION -->
                        ...
                        <tr>
                            ...
                            <td class="debit-col">{{ number_format($cashinhanddebit, 2) }}</td>
                            <td class="credit-col">{{ number_format($cashinhandcredit, 2) }}</td>
                        </tr>
                        <tr>
                            <td class="account-col">Bank</td>
                            <td class="debit-col">{{ number_format($bankdebit, 2) }}</td>
                            <td class="credit-col">{{ number_format($bankcredit, 2) }}</td>
                        </tr>
                        <tr>
                            <td class="account-col">Account Receivable</td>
                            <td class="debit-col">{{ number_format($credit, 2) }}</td>
                            <td class="credit-col"></td>
                        </tr>
                        <tr>
                            <td class="account-col">Current Asset</td>
                            <td class="debit-col">{{ number_format($currentassetSum, 2) }}</td>
                            <td class="credit-col"></td>
                        </tr>
                        <tr>
                            <td class="account-col">Fixed Asset</td>
                            <td class="debit-col">{{ number_format($fixedassetSum, 2) }}</td>
                            <td class="credit-col"></td>
                        </tr>
                        <tr>
                            <td class="account-col">Purchase VAT</td>
                            <td class="debit-col">{{ number_format($purchasevat, 2) }}</td>
                            <td class="credit-col"></td>
                        </tr>
                        <tr>
                            <td class="account-col">Purchase Return VAT</td>
                            <td class="debit-col"></td>
                            <td class="credit-col">{{ number_format($purchasereturnvat, 2) }}</td>
                        </tr>
                         <tr>
                            <td class="account-col">Discount Allowed</td>
                            <td class="debit-col">{{ number_format($totaldiscount, 2) }}</td>
                            <td class="credit-col"></td>
                        </tr>
                        <tr>
                            <td class="account-col">Discount Received</td>
                            <td class="debit-col"></td>
                            <td class="credit-col">{{ number_format($totaldiscountpurchase, 2) }}</td>
                        </tr>
                        <!-- LIABILITIES SECTION -->
                        <tr class="section-header">
                        ...
                        <tr>
                            ...
                            <td class="debit-col"></td>
                            <td class="credit-col">{{ number_format($supplier, 2) }}</td>
                        </tr>
                        <tr>
                            <td class="account-col">Sales VAT</td>
                            <td class="debit-col"></td>
                            <td class="credit-col">{{ number_format($salevat, 2) }}</td>
                        </tr>
                        <tr>
                            <td class="account-col">Sales Return VAT</td>
                            <td class="debit-col">{{ number_format($salereturnvat, 2) }}</td>
                            <td class="credit-col"></td>
                        </tr>
                        <tr>
                            <td class="account-col">Long Term Liabilities</td>
                            <td class="debit-col"></td>
                            <td class="credit-col">{{ number_format($longliabilitySum, 2) }}</td>
                        </tr>
                        <tr>
                            <td class="account-col">Short Term Liabilities</td>
                            <td class="debit-col"></td>
                            <td class="credit-col">{{ number_format($shortliabilitySum, 2) }}</td>
                        </tr>
                        ...
                        <tr class="section-header">
                         ...
                         <tr>
                            ...
                            <td class="debit-col"></td>
                            <td class="credit-col">{{ number_format($bankbalance, 2) }}</td>
                        </tr>
                        <tr>
                            <td class="account-col">Owner's Capital</td>
                            <td class="debit-col"></td>
                            <td class="credit-col">{{ number_format($ownerscapitalSum, 2) }}</td>
                        </tr>
                        <tr>
                            <td class="account-col">Investment Reserves</td>
                            <td class="debit-col"></td>
                            <td class="credit-col">{{ number_format($investmentcapitalSum, 2) }}</td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="debit-col"></td>
                            <td class="credit-col">{{ number_format($salefullTotal, 2) }}</td>

                        </tr>
                        <tr>

                            <td class="account-col">Sales Return</td>
                            <td class="debit-col">{{ number_format($salesreturnwithoutvat, 2) }}</td>
                            <td class="credit-col"></td>
                        </tr>
                        <tr>
                            <td class="account-col">Other Incomes</td>
                            <td class="debit-col"></td>
                            <td class="credit-col">{{ number_format($totalIncome, 2) }}</td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="debit-col">{{ number_format($purchasefullTotal, 2) }}</td>
                            <td class="credit-col"></td>
                        </tr>
                         <tr>
                            <td class="account-col">Purchase Return</td>
                            <td class="debit-col"></td>
                            <td class="credit-col">{{ number_format($purchasesreturnwithoutvat, 2) }}</td>
                        </tr>
                        <tr>
                            <td class="account-col">Other Expenses</td>
                            <td class="debit-col">{{ number_format($totalexpenses, 2) }}</td>
                            <td class="credit-col"></td>
                        </tr>
                        ...
                        <tr class="totals-row">
                            ...
                            <td class="debit-col">{{ number_format($totalDebit, 2) }}</td>
                            <td class="credit-col">{{ number_format($totalCredit, 2) }}</td>
                        </tr>
                    </tbody>
                </table>
                <br><br>
