        ...
        <nav aria-label="breadcrumb">
          ...
          <div class="dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                <a href="/chartaccounts" class="dropdown-item ">Add Asset</a>
                        ...
                        <tbody>
                            @foreach ($assets as $asset)
                                <tr>
                                    ...
                                    <td>{{ $asset->sub_type }}</td>
                                    <td>{{ $asset->type_category }}</td>
                                    <td>{{ $asset->type_name }}</td>
                                    <td>{{ $asset->type_amount }}</td>
                                    <td>{{ $asset->type_details }}</td>
                                    <td>{{ $asset->type_date }}</td>
