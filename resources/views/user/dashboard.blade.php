...
<body>
    ...
    <div id="content">
                ...
                <div class="user-section">
                    ...
                    <div class="user-details">
                        @foreach($userdatas as $userdata)
                            <p>{{ ucfirst(strtolower($userdata['name'])) }}</p>
                        @endforeach
                        <a href="/edituser/{{ $userid }}">Change Password</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        @if($expirationDate <= Carbon::now()->toDateString())
                ...
                <div class="left-column">
                    <div class="stats-grid compact-stat">
                        ...
                        <div class="stat-card">
                            <div class="stat-header">
                                <div>
                                    <div class="stat-value">{{ $currency }} {{ number_format($todayservice, 3) }}</div>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="report-category">
                                        ...
                                        <div class="report-options">
                                            <a href="/export-sales-day/{{ $userid }}/1/{{ $location }}/{{$todayDate}}" class="report-option"><i class="fas fa-calendar-alt"></i> Today's Sales</a>
                                            <a href="/export-sales-month/{{ $userid }}/2/{{ $location }}/{{$monthid}}" class="report-option"><i class="fas fa-chart-bar"></i> Monthly Sales</a>
                                            <a href="/export-sales-year/{{ $userid }}/3/{{ $location }}/{{ $currentYear }}" class="report-option"><i class="fas fa-chart-line"></i> Annual Sales</a>                                
                                        </div>
                                    </div>
                                    <div class="report-category">
                                        <h4 class="report-category-title">Purchase Reports</h4>
                                        <div class="report-options">
                                            <a href="/export-purchase-day/{{$userid}}/1/{{$location}}/{{$todayDate}}" class="report-option"><i class="fas fa-shopping-cart"></i> Today's Purchases</a>
                                            <a href="/export-purchase-month/{{$userid}}/2/{{$location}}/{{$monthid}}" class="report-option"><i class="fas fa-list-alt"></i> Monthly Purchases</a>
                                            <a href="/export-purchase-year/{{$userid}}/3/{{$location}}/{{$currentYear}}" class="report-option"><i class="fas fa-book"></i> Annual Purchases</a>
                                        </div>
                                    </div>
                                    <div class="report-category">
                                        <h4 class="report-category-title">Export Data</h4>
                                        <div class="report-options">
                                            <a href="{{ route('exportproductreport') }}" class="report-option"><i class="fas fa-file-export"></i> Export Product Report</a>
                                            <a href="{{ url('export-product') }}" class="report-option"><i class="fas fa-file-export"></i> Export Products</a>
                                            <a href="{{ route('printstocklist') }}" class="report-option"><i class="fas fa-boxes"></i> Export Stock</a>
                                            <a href="{{ url('/export-expense-history') }}" class="report-option"><i class="fas fa-file-export"></i> Export Expenses</a>
                                            <?php
                                            $start_date = $end_date = Carbon::now()->format('Y-m-d');
                                            ?>
                                            <a href="/exportpandl/{{ $start_date }}/{{ $end_date }}/{{$location}}" class="report-option"><i class="fas fa-file-invoice-dollar"></i> Export Profit & Loss</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="modal-footer"><button type="button" class="btn btn-default" data-dismiss="modal">Close</button></div>
                        ...
                        <div class="performance-grid">
                            <div style="padding-right: 10px; padding-left: 10px;">
                                ...
                                <div class="performance-list" id="topProducts">
                                    ...
                                    <div class="performance-item">
                                        ...
                                        <span class="high-performer">{{ number_format($product->total_sales, 2) }}</span>
                                    </div>
                                    @endforeach
                                </div>
                            </div>
                            <div style="padding-left: 10px; padding-right: 10px;">
                                ...
                                <div class="performance-list" id="bottomProducts">
                                    ...
                                    <div class="performance-item">
                                        <span>{{ $product->product_name }}</span>
                                        <span class="low-performer">{{ number_format($product->total_sales, 2) }}</span>
                                    </div>
                                    @endforeach
                                </div>
                            </div>
