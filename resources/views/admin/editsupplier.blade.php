...
<body>
    ...
    <div id="content">
        ...
        <form action="/supplieredit" method="POST" id="supplier_edit" name="supplier_edit" onsubmit="return(validateSearch());">
        @csrf
        ...
        <div class="form-group">
                <input type="hidden" class="form-control" name="id" value="{{ $uid }}">
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control name" name="name"  value="{{ $supplier->name }}" autocomplete="name" readonly>
                ...
                <div class="input-group mb-3" style="margin-top: 10px;">
                    <span class="input-group-addon">Trade License No</span>
                        <input type="text" class="form-control" name="trade_license_no"  value="{{ $supplier->trade_no }}" autocomplete="trade_license_no">
                    <span style="color:red">@error('trade_license_no') {{ $message }} @enderror</span>
                </div>
                <div class="input-group mb-3" style="margin-top: 10px;">
                    <span class="input-group-addon">TRN Number</span>
                        <input type="text" class="form-control trn" name="trn_number"  value="{{ $supplier->trn_number }}">
                    <span style="color:red">@error('trn_number') {{ $message }} @enderror</span>
                </div>
                <div class="input-group mb-3" style="margin-top: 10px;">
                    <span class="input-group-addon">Mobile Number</span>
                        <input type="text" class="form-control mobile" name="mobile" value="{{ $supplier->mobile }}">
                    <span style="color:red">@error('mobile') {{ $message }} @enderror</span>
                </div>
                <div class="input-group mb-3" style="margin-top: 10px;">
                    <span class="input-group-addon">Email</span>
                        <input type="email" class="form-control email" name="email"  value="{{ $supplier->email }}">
                    <span style="color:red">@error('email') {{ $message }} @enderror</span>
                </div>
                <div class="input-group mb-3" style="margin-top: 10px;">
                    <span class="input-group-addon">Branch <span style="color: red;">*</span></span>
                        <select name="locationdrop" class="control location" disabled>
                            <option value="" selected>Branch</option>
                            @foreach ($locations as $location)
                            <option value="{{ $location->id }}" {{ $location->id == $supploc->location ? 'selected' : '' }}>
                                {{ $location->location }}
                            </option>
                            @endforeach
                        </select>
                    <input type="hidden" name="location" id="location" value="{{ $supploc->location }}">
        ...
        <h4 class="text-center" style="margin-bottom: 20px;">Address</h4>
                <div class="form-group">
                    <div class="input-group mb-3" style="margin-top: 10px;">
                        ...
                        <input type="text" class="form-control" name="billing_address"  value="{{ $supplier->billing_add }}" autocomplete="billing_address">
                    <span style="color:red">@error('billing_address') {{ $message }} @enderror</span>
                </div>
                    <div class="input-group mb-3" style="margin-top: 10px;">
                        <span class="input-group-addon">City</span>
                        <input type="text" class="form-control" name="billing_city"  value="{{ $supplier->billing_city }}">
                    <span style="color:red">@error('billing_city') {{ $message }} @enderror</span>
                </div>
                    <div class="input-group mb-3" style="margin-top: 10px;">
                        <span class="input-group-addon">State/Province</span>
                        <input type="text" class="form-control" name="billing_state"  value="{{ $supplier->billing_state }}">
                    <span style="color:red">@error('billing_state') {{ $message }} @enderror</span>
                </div>
                    <div class="input-group mb-3" style="margin-top: 10px;">
                        <span class="input-group-addon">Postal/ZIP Code</span>
                        <input type="text" class="form-control" name="billing_zip"  value="{{ $supplier->billing_postal }}">
                    <span style="color:red">@error('billing_zip') {{ $message }} @enderror</span>
                </div>
                    <div class="input-group mb-3" style="margin-top: 10px;">
                        <span class="input-group-addon">Landmark</span>
                        <input type="text" class="form-control" name="billing_landmark"  value="{{ $supplier->billing_landmark }}">
                    <span style="color:red">@error('billing_landmark') {{ $message }} @enderror</span>
                </div>
                    <div class="input-group mb-3" style="margin-top: 10px;">
                        <span class="input-group-addon">Country</span>
                        <input type="text" class="form-control" name="billing_country"  value="{{ $supplier->billing_country }}">
                ...
                <div class="form-check mb-3" style="margin-top: 10px;">
                    ...
                    <div class="input-group mb-3" style="margin-top: 10px;">
                        ...
                        <input type="text" class="form-control" name="delivery_address"  value="{{ $supplier->deli_add }}">
                    <span style="color:red">@error('delivery_address') {{ $message }} @enderror</span>
                </div>
                    <div class="input-group mb-3" style="margin-top: 10px;">
                        <span class="input-group-addon">City</span>
                        <input type="text" class="form-control" name="delivery_city"  value="{{ $supplier->deli_city }}">
                    <span style="color:red">@error('delivery_city') {{ $message }} @enderror</span>
                </div>
                    <div class="input-group mb-3" style="margin-top: 10px;">
                        <span class="input-group-addon">State/Province</span>
                        <input type="text" class="form-control" name="delivery_state"  value="{{ $supplier->deli_state }}">
                    <span style="color:red">@error('delivery_state') {{ $message }} @enderror</span>
                </div>
                    <div class="input-group mb-3" style="margin-top: 10px;">
                        <span class="input-group-addon">Postal/ZIP Code</span>
                        <input type="text" class="form-control" name="delivery_zip"  value="{{ $supplier->deli_postal }}">
                    <span style="color:red">@error('delivery_zip') {{ $message }} @enderror</span>
                </div>
                    <div class="input-group mb-3" style="margin-top: 10px;">
                        <span class="input-group-addon">Landmark</span>
                        <input type="text" class="form-control" name="delivery_landmark"  value="{{ $supplier->deli_landmark }}">
                    <span style="color:red">@error('delivery_landmark') {{ $message }} @enderror</span>
                </div>
                    <div class="input-group mb-3" style="margin-top: 10px;">
                        <span class="input-group-addon">Country</span>
                        <input type="text" class="form-control" name="delivery_country"  value="{{ $supplier->deli_country }}">
    ...
    <div class="form-section " style="width: 700px;">
        ...
        <div class="form-group">
            <div class="input-group bank">
                ...
                <input name="accountName" type="text" class="form-control" id="accountName" tabindex="1" value="{{ $supplier->b_accountname }}" autocomplete="accountName" >
                <span style="color:red">@error('accountName') {{ $message }} @enderror</span>
            </div>
            <div class="input-group bank">
                <span class="input-group-addon">Bank Name</span>
                <input name="bank_name" type="text" class="form-control" id="bank_name" value="{{ $supplier->b_bankname }}"  autocomplete="bank_name" >
                <span style="color:red">@error('bank_name') {{ $message }} @enderror</span>
            </div>
            <div class="input-group bank">
                <span class="input-group-addon">Branch</span>
                <input type="text" class="form-control" name="branch"  autocomplete="branch"value="{{ $supplier->b_branch }}">
            ...
            <div class="input-group bank" id="ifscField" style="display:none;">
                ...
                <input name="ifscCode" type="text" class="form-control" id="ifscCode"  autocomplete="ifscCode"value="{{ $supplier->b_ifsc }}">
                <span style="color:red">@error('ifscCode') {{ $message }} @enderror</span>
            </div>
            <div class="input-group bank" id="ibanField" style="display:none;">
                <span class="input-group-addon">Enter IBAN Number</span>
                <input name="ibanCode" type="text" class="form-control" id="ibanCode"    autocomplete="ibanCode"value="{{ $supplier->b_iban }}">
                <span style="color:red">@error('ibanCode') {{ $message }} @enderror</span>
            </div>
        </div>
        ...
        <div class="input-group bank">
                ...
                <input name="account_number" type="text" class="form-control" id="account_number"   autocomplete="account_number"value="{{ $supplier->b_accountno }}">
                <span style="color:red">@error('account_number') {{ $message }} @enderror</span>
            </div>
            <div class="input-group bank">
                <span class="input-group-addon">Date</span>
                <input name="date" type="date" class="form-control" id="date"   autocomplete="date"value="{{ $supplier->b_date }}">
                <span style="color:red">@error('date') {{ $message }} @enderror</span>
            </div>
            <div class="input-group bank">
                <span class="input-group-addon">Account Type</span>
                <select name="accountType" class="control" id="accountType"  autocomplete="accountType"value="{{ $supplier->b_accounttype }}">
            ...
            <!--    <input name="upiid" type="text" class="form-control" id="upiid"    autocomplete="upiid"value="{{ $supplier->b_upiid }}">-->
            <!--    <span style="color:red">@error('upiid') {{ $message }} @enderror</span>-->
            <!--</div>-->
            <div class="input-group bank">
                <span class="input-group-addon">Country</span>
                <input name="country" type="text" class="form-control" id="country"  autocomplete="country-name" autocomplete="country"value="{{ $supplier->b_country }}">
...
<div class="text-center mt-4">
    <button type="submit" class="btn btn-primary submitsupplier" id="submitBtnSupp">UPDATE</button>
                </div>
            </div>
        </form>
    </div>
...
<script>
    $(function() {
        $('#supplier_edit').keypress(function(e) { //use form id
            if (e.which == 13) {
                validateSearch(); //-- to validate form
                $('#supplier_edit').submit(); // use form id
                return false;
            }
        });
    });
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        const form = document.getElementById("supplier_edit");
