                ...
                <table id="example" class="table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="/purchasereportdetails/{{$product->transaction_id}}" class="btn btn-primary">VIEW</a>
                            </td>
                            <td>
                                <a href="/admingeneratetax-pdf/{{$product->transaction_id}}" class="btn btn-primary">PRINT</a>
                            </td>
                            @endforeach
                        </tr>
                    </tbody>
