        ...
        <table id="example" class="table table-striped table-bordered">
            <thead>
                <tr>
                    ...
                    <th width="5%">Total Stocks Quantity</th>
                    <th width="5%">Remaining Stocks Quantity</th>
                    <th width="5%">Sold Stocks Quantity</th>
                    <th width="5%">Total Stock Value</th>
                    <th width="5%">Remaining Stock Value</th>
                    <th width="5%">Sold Stock Value(MRP)</th>
                    <th width="5%">Discount Amount</th>
                    <th width="5%">Profit Sum</th>
            ...
            <tbody>
                @foreach ($stocks as $stock)
                    <tr>
                        ...
                        <td>
                            <a href="/stockaddhistory/{{ $location_id }}/{{ $stock->id }}"
                                class="btn btn-primary">VIEW</a>
                        </td>
                        <td>
                            <a href="/stocktransactionhistory/{{ $location_id }}/{{ $stock->id }}"
                                class="btn btn-primary">VIEW</a>
                        </td>
                        @php
