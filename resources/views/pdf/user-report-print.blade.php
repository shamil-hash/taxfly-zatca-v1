...
<body>
    <div class="container">
        <h1 style="text-align: center; font-size: 24px; margin-bottom: 5px;">{{ $company }}</h1>
        <h2 style="text-align: center; font-size: 18px; margin-bottom: 10px;">User Report</h2>
        ...
        @foreach ($userdatas as $userdata)
            ...
            <div style="font-size: 14px; margin-bottom: 10px;">
                <b>Login Info:</b> {{ date('d-M-Y : h:i:s A', strtotime($userdata['last_login'])) }}
            </div>
        @endforeach
