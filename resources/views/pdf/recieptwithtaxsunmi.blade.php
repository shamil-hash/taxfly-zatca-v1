							...
							<div class="card-body p-0">
								<div class="invoice-container">
									<div class="invoice-header">
										...
										<!-- Row start -->
										<div align="center" >
											<img src="{{public_path('/storage/logo/logo.jpg')}}" alt="logo" width="90px">
										</div>
										<table class="heading">
											<tr>
												<td>
												...
												<td>
													<div align="right">
														<img src="data:image/png;base64, {{ base64_encode(QrCode::size(20)->generate('http://avolon.netplexsolution.com/generatepublic-pdf/'.$enctrans)) }} ">
													</div>
												</td>
											</tr>
										</table>
														...
														<tbody>
															...
															<tr>
																...
																<td>
																	...
																	<p class="text-success" style="font-size:8px;"><strong>{{$grandinnumber}} {{$currency}}</strong></p>
																</td>
															</tr>
														</tbody>
													</table>
