...
<th style="width: 10%;font-size:12px;">Box/ Dozen</th>
<th style="width: 11%;font-size:12px;">Qty</th>
<th style="width: 8%;font-size:12px;">Unit</th>
<th style="width: 11%;font-size:12px;">Buycost</th>
<th style="width: 12%;font-size:12px;">{{$tax}} Amount</th>
...
@foreach ($details as $detail)
    <tr>
        ...
        <td style="height: 22px; border-bottom: 0.5px solid #000;font-size:10px;"> @if ($detail->is_box_or_dozen == 1)
                                                                    BOX
        ...
        <td style="height: 22px; border-bottom: 0.5px solid #000;font-size:10px;">{{ $detail->buycost }}</td>
        <td style="height: 22px; border-bottom: 0.5px solid #000;font-size:10px;">{{ $detail->price - $detail->price_without_vat }}</td>
        <td style="height: 22px; border-bottom: 0.5px solid #000;font-size:10px;">{{ $detail->price }}</td>
    </tr>
@endforeach
...
@endif
    ...
    <tfoot>
        ...
        <tr class="total-row">
            ...
            <td colspan="2" class="text-right" style="text-align: right; padding-right: 15px;font-weight:bold;">Grand Total (AED)</td>
