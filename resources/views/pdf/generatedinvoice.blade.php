                        ...
                        <div class="card-body p-0">
                            <div class="invoice-container">
                                <div class="invoice-header">
                                                ...
                                                @foreach ($shopdatas as $shop)
                                                    @if ($shop->logo)
                                                        <img class="imagecss"
                                                            ...
                                                            alt="logo" style="padding-bottom:15px;" width="300px">
                                                    @endif
                                                @endforeach
                                            @endif
                                        </div>
                                    ...
                                    <div align="center">
                                        <p
                                            style="font-family:'Poppins', sans-serif;font-size: 1.4em;background-color:#ADD8E6;">
                                            {{ $invoice_type }}</p>
                                    </div>
                                    <br>
                                    <table class="heading">
                                    ...
                                    <!-- Row end -->
                                    <div align="center">
                                        <p style="font-family:'Poppins', sans-serif;font-size: 1.5em;">
                                            {{ $heading }}</p>
                                    </div>
                                </div>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @foreach ($details as $detail)
                                                            <tr>
                                                                ...
                                                                <td>{{ ($detail->fixed_vat * $detail->price) / 100 }}
                                                                </td>
                                                                <td>{{ ($detail->fixed_vat * $detail->price) / 100 + $detail->price }}
                                                                </td>
                                                            </tr>
                                                            <?php $number++; ?>
                                                        @endforeach
                                                        ...
                                                        <tr>
                                                            <td colspan="6">
                                                                ...
                                                                <h6 class="text-success"><strong>Amount in Words :
                                                                        {{ $amountinwords }}</strong></h6>
                                                            </td>
                                                            <td>
                                                                <p>
                                                                    Subtotal<br>
                                                            ...
                                                            <td>
                                                                ...
                                                                <h5 class="text-success"><strong>{{ $totals + $vat }}
                                                                        {{ $currency }}</strong></h5>
                                                            </td>
                                                        </tr>
                                                    </tbody>
