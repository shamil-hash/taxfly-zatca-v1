...
<body>
    ...
    <nav class="navbar navbar-default">
        ...
        <div align="right">
            ...
            <!--sir-->
            <!--<a href="/print" class="btn btn-primary">PRINT SUNMI</a>--> <!-- sir code-->
                                ...
                                <div class="invoice-header">
                                    ...
                                    <div class="row gutters">
                                        <div class="image col-xl-6 col-lg-6 col-md-6 col-sm-6">
                                            <img class="imagecss" src="{{ asset('storage/logo/logo.jpg') }}"
                                                alt="logo" style="padding-bottom:15px;">
                                            <br>
                                        </div>
                                        <div align="right" class="col-lg-6 col-md-6 col-sm-6">
                                            {!! QrCode::size(150)->generate('http://www.plexpay.plexbill.com/generatepublic-pdf/' . $enctrans) !!}
                                        </div>
                                    </div>
                                    ...
                                    <div align="center">
                                        <p
                                            style="font-family:'Poppins', sans-serif;font-size: 1.4em;background-color:#20639B;color: white;">
                                            INVOICE</p>
                                    </div>
                                    <!-- Row end -->
                                    <!-- Row start -->
                ...
                <script type="text/javascript">
                    ...
                    function wcppDetectOnSuccess() {
                        ...
                        if (wcppVer.substring(0, 1) == "6") {
                            ...
                            // 			$('#printModal .modal-body').html(wcpScript);
                            ...
                            // window.location.href = "{{ route('getWcpScript', $trans) }}";
