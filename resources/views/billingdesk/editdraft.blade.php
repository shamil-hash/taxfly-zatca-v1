...
<body>
    ...
    @endif
        ...
        <form method="post" action="/submitdatadraft/edit/{{ $transaction_id }}" onsubmit="return validateForm();"
            id="billForm">
            @csrf
            ...
            <div class="form group row">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="input-group">
                            ...
                            @if ($payment_type == 3)
                                <x-Form.input type="hidden" style="width: 150px;" id="{{ $credit_user_id }}"
                ...
                <div>
                    <div class="row" style="margin: 1rem; background-color: #f2f2f2;padding:1rem;">
                            ...
                            <div class="col-sm-3"
                                ...
                                <div class="input-group form-inline"
                                    ...
                                    <div class="form-group" style="display: flex; align-items: center; ">
                                        ...
                                        <x-Form.input type="text" style="width: 150px;" id="payment_mode"
                                            name="payment_mode" value="{{ $type }}" readonly />
                                        <x-Form.input type="hidden" style="width: 150px;" id="payment_type"
                                            name="payment_type" value="{{ $payment_type }}" readonly />

                                        @if ($payment_type == 3)
                                            <x-Form.input type="hidden" style="width: 150px;"
                                                id="{{ $credit_user_id }}" name="{{ $credit_user_id }}"
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3"
                                ...
                                <div class="input-group form-inline"
                                    style="display: flex; align-items: center; margin-bottom: 6px;">
                                    <div class="form-group" style="display: flex; align-items: center; ">
                                        <label for="advance" class="mr-2" style="margin-right: 15px;">Advance
                                            Payment : </label>
                                        <br />
                                        <input type="text" name="advance" id="advance"
                                            value="{{ $advance }}" class="form-control"
                                            style="width: 147px;border-radius:5px;margin-right:3px;" />
                                    </div>
                                    <br>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-2">
                            <input class="btn btn-primary" type="submit" value="submit" id="confirmBtn">
                        </div>
                    </div>
                </div>
            </div>
...
<script type="text/javascript">
    ...
    function handleDiscountChange(u) {
        ...
        //     if (vat_type == 1) {
        //         if (discount__type == "none" || ((discount__type == "percentage" || discount__type ==
        //                 "amount") && discount == "")) {
        ...
        //                         subInclusiveRate * (discounts / 100);
        //                     var inclus_disocunt_amt =
        ...
        //                 var InclusiveRate =
        //                     subInclusiveRate - inclus_disocunt_amt;
        ...
        //                 var without_disc_amnt =
        //                     subInclusiveRate - discnt_amount;
        //                 var wo_disc_wo_vat =
        //                     without_disc_amnt / (1 + fixed_vat / 100);
        //                 var vat_am = without_disc_amnt - wo_disc_wo_vat;

        //                 netrate = without_disc_amnt + vat_am;
        //                 var grandtotal = netrate * quantity;
        //                 var grandtotal_wo_disc = mrp * quantity;
        //                 var grandvat = vat_am * quantity;
        //                 total_wo_discount = subInclusiveRate * quantity;
        //                 total = without_disc_amnt * quantity;
        ...
        if (page == 'edit_bill') {
            ...
            addRowDiscountCalculation(u, remstk, vat_type, billq, page);
