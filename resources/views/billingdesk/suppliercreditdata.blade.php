...
<head>
    ...
    <title>Supplier Credit Statement</title>
...
<body>
    ...
    <div id="content">
        ...
        <form action="{{ url('/suppliercredit_trans_history/' . $credit_supplier_id) }}" method="GET" onsubmit="return validateDates()">
            <div class="row">
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                @foreach($allTransactions as $transaction)
                    @php
                        $isCredit = isset($transaction['credit_supplier_id']); // Check if it's a credit transaction
                    @endphp
                    ...
                    <tr>
                        ...
                        <td>
                                ...
                                Credit
                                @else
                                    {{ $transaction['payment_type'] == 1 ? 'Cash' : ($transaction['payment_type'] == 3 ? 'Bank' : '') }}
                                @endif
                            </td>
                        ...
                        <td>
                            ...
                            @if (!empty($transaction['collectedamount']))
                            {{$currency}} {{ $transaction['collectedamount'] }}
                        @endif
                        @endif
                        @else
        ...
        <div class="row">
            ...
            <div class="col-sm-2">
                <div align="right" class="print-button">
                    ...
                    @else
                        <a href="{{ route('supplier_credit.statement.pdf', ['supplier_credit_id' => $credit_supplier_id, 'start_date' => $startDate, 'end_date' => $endDate]) }}"
