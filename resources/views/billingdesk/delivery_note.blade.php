...
<body>
    ...
    @endif
       ...
       <!-- <a href="/history/deliverynote" class="btn btn-info">Delivery Note History</a>-->
       <!-- <div>-->
       <!-- @include('layouts.quick')-->

       <!--     <a href="/draft/deliverydraft" class="btn btn-warning ">Drafts</a>-->
       ...
       <!-- </div>-->
         <div class="dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                <a href="/draft/deliverydraft" class="dropdown-item ">Drafts</a>
                <a href="/history/deliverynote" class="dropdown-item ">Delivery Note History</a>
    ...
    @endif
    <br><br>
        <form method="post" action="deliverynote_submit" onsubmit="return validateForm();" id="billForm">
            @csrf

            <input type="hidden" name="page" id="page" value="delivery">
<div class="form group row" >
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="input-group">
                            ...
                            <input style="width: 100px; font-size: 12px;height:auto;" id="cust_id" name="customer_name"
                    ...
                    <div class="col-md-3">
                        <div class="input-group">
                            ...
                            <input style="width: 100px; font-size: 12px;height:auto;" id="trn_number" name="trn_number" class="form-control trn_no"
                                placeholder="TRN Number:">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="input-group">
                            <span class="input-group-addon" id="basic-addon1" style="font-size: 10px; width: 120px;">Phone Number</span>
                            <input style="width: 100px; font-size: 12px;height:auto;" id="phone" name="phone" class="form-control phone"
                                placeholder="Phone:">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="input-group">
                            ...
                            <input style="width: 100px; font-size: 12px;height:auto;" id="email" name="email" class="form-control email">
                        </div>
                    </div>
                </div>
                <div class="row" style="margin-top: 10px;">
                    ...
                    <div class="col-md-3">
                        <div class="input-group">
                            <span class="input-group-addon" id="basic-addon1" style="font-size: 10px; width: 120px;">Land Mark</span>
                            <input type="text" style="width: 100px; font-size: 12px;height:auto;" id="land_mark" name="land_mark"
                                class="form-control land_mark">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="input-group">
                            <span class="input-group-addon" id="basic-addon1" style="font-size: 10px; width: 120px;">Delivery
                                Date</span>
                            <input type="date" style="width: 100px; font-size: 12px;" id="delivery_date" name="delivery_date"
                                class="form-control delivery_date">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="input-group">
                            <span class="input-group-addon" id="basic-addon1" style="font-size: 10px; width: 120px;">Location</span>
                            <input type="text" style="width: 100px; font-size: 12px;height:auto;" id="location" name="location"
                                class="form-control location">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="input-group">
                            <span class="input-group-addon" id="basic-addon1" style="font-size: 10px; width: 120px;">Area</span>
                            <input type="text" style="width: 100px; font-size: 12px;height:auto;" id="area" name="area"
                ...
                <div class="row" style="margin-top: 10px;">
                    ...
                    <div class="col-md-3">
                        <div class="input-group">
                            <span class="input-group-addon" id="basic-addon1" style="font-size: 10px; width: 120px;">Villa No.</span>
                            <input type="text" style="width: 100px; font-size: 12px;height:auto;" id="villa_no" name="villa_no"
                                class="form-control villa_no">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="input-group">
                            <span class="input-group-addon" id="basic-addon1" style="font-size: 10px; width: 120px;">Flat No</span>
                            <input type="text" style="width: 100px; font-size: 12px;height:auto;" id="flat_no" name="flat_no"
                                class="form-control flat_no">
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="input-group">
                            ...
                            <input type="text" id="barcodenumber" name="barcodenumber" style="width: 100px; font-size: 12px;height:auto;"
                    ...
                    <div class="row" style="margin: 1rem; background-color: #f8f9fa;padding:1rem;">
                        ...
                        <div class="col-md-3"
                            ...
                            <div class="input-group" style="display: flex; align-items: center; margin-bottom: 6px;">
                                <label for="delivery_grand_total" class="mr-2" style="margin-right: 10px;">Grand
                                    Total:</label>
                                <input type="text" id="delivery_grand_total" name="delivery_grand_total"
                                    class="form-control-plaintext border-0"
                                    style="width: 70px; background: transparent; border: none;" readonly>
                            </div>
                            <div class="input-group" style="display: flex; align-items: center;">
                                <label for="delivery_grand_total_wo_discount" class="mr-2"
                                    style="margin-right: 10px;">Grand
                                    Total without Discount:</label>
                                <input type="number" id="delivery_grand_total_wo_discount"
                                    name="delivery_grand_total_wo_discount" class="form-control-plaintext border-0"
                                    style="width: 70px; background: transparent; border: none;" readonly>
                            </div>
                        </div>
...
<script>
    function saveToDraft() {
        ...
        form.action = "{{ route('data.savedeliveryDraft') }}";
        if (validateForm()) {
            form.submit();
        }
    }
...
<script>
    $(document).ready(function() {
        $(".delivery_credit").select2({
            theme: "classic",
        });

        $(".delivery_product").select2({
            theme: "classic",
        });
...
<script type="text/javascript">
    ...
    function updateGrandTotalAmount() {
        ...
        $('.total-amount-delivery').each(function() {
            grandtotal += Number($(this).val());
        });

        grandtotal = grandtotal.toFixed(2);
        grandtotal = parseFloat(grandtotal);
        $('#delivery_grand_total_wo_discount').val(grandtotal);
        ...
        grandtotal = grandtotal.toFixed(2);
        grandtotal = parseFloat(grandtotal);
        $('#delivery_grand_total').val(grandtotal);
    }
    ...
    function addRow() {
        ...
        tr += '<td><input type="number" value=' + q + ' name="fixed_vat[' + u +
            ...
            ']" class="form-control total-amount-delivery" readonly><input type="hidden" value=' + p +
