    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="myNavbar">
        <ul class="nav navbar-nav link2">
            ...
            <li class="{{Request::is('listcredituser')||Request::is('editcredituser/*')? 'active' : '' }}"> <a href="/listcredituser" class="btn btn-custom"> </i>List Customer</a></li>
            <li class="{{Request::is('createcredit')? 'active' : '' }}"> <a href="/createcredit" class="btn btn-custom"> </i>Create Customer</a></li>
