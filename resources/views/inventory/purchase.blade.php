    ...
    <div id="content">
        ...
        <div class="header-container">
            ...
            <div class="dropdown-quick-container">
                ...
                <a style="border-radius: 5px;padding: 8px;" class="dropdown-item btn-info" data-toggle="modal" data-target="#addCustomerModal">Add New Supplier</a>
        ...
        @include('modal.product_modal.add_product_modal', [
            ...
            'page' => $page,
             ...
             @include('modal.add_supplier_modal')
                ...
                <table id="mytable" class="responsive" style="border-radius: 8px;">
                    <thead>
                        <tr>
                            ...
                            <th width="9%" id="quantity_header" style="display: none;" colspan="2">Quantity
                            </th>
                            ...
                            <td>
                                <div class="input-group">
                                    <select name="mode" class="form-control"
                                        onchange="addExtraColumns(this.value)" style="width: 150px;" tabindex="12">
