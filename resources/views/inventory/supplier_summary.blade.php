        ...
        @elseif(Session('softwareuser'))
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Debit Note Supplier Summary</li>
                </ol>
            </nav>
        @endif

        <!-- content -->
        <h2>Debit Note Supplier Summary</h2>

        <table id="example" class="table table-striped table-bordered">
            <thead>
                <tr>
                    <th width="50%">Supplier Name</th>
                    <th width="50%">Total Debit Note Amount</th>
                </tr>
            </thead>
            <tbody>
                ...
                @foreach ($products as $product)
                    <tr>
                        ...
                        <td>
                            <b>{{ $currency }}</b> {{ $product->debit_note_amount }}
                        </td>
