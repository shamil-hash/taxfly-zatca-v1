...
@endif
        ...
        <div class="input-group">
            <input class="form-control" style="width: 180px;border-radius: 3px;" id="query" type="text"
                name="query" placeholder="Search"> &nbsp
            <button class="btn btn-primary" onclick="myFunction()">Search</button>
        </div>
        <br>
            ...
            <table id="mytable" class="dataTables-example"  style="background-color:white;">
                <thead>
                    <tr>
                        ...
                        <th width="15%" style="display:none;">Product Details</th>
                ...
                <tbody>
                    ...
                    @foreach ($details as $index => $detail)
                        <tr class="x{{ $detail->status }}">
                            ...
                            <td style="display:none;">
                                <input type="text" name="prate[]" value="{{ $detail->rate }}" class="form-control"
                                    tabindex="{{ $index * 7 + 16 }}" readonly>
                            </td>
                            <td style="display:none;">
                            ...
                            <td>
                                ...
                                <select name="pcategory_id[]" id="category" class="form-control"
                                    style="width: 200px" tabindex="{{ $index * 7 + 19 }}">
                            ...
                            <td>
                                <input style="width: 150px;" id="exist_barcode" name="pexist_barcode[]"
...
@endif-->
                            ...
                            <td>
                                ...
                                <?php } else { ?>
                                <a href="{{ url('/changeproductstatus', $detail->id) }}"
