...
<head>
    ...
    <title>Edit Draft-Purchase</title>
...
<body>
    ...
    <div id="content">
        ...
        <form method="post" action="/submitpurchasedraft/{{$reciept_no}}"
            enctype="multipart/form-data" id="purchase_form" name="purchase_form"
                    ...
                    <div class="col-md-4">
                        <div class="input-group">
                            ...
                            <x-Form.input type="text" id="reciept_nos" name="reciept_no" class="receiptno"
                                aria-describedby="basic-addon1" autocomplete="off" value="{{ $reciept_no }}"
                                readonly /> <br />
                        </div>
...
<script>
    ...
    document.getElementById("confirmBtn").addEventListener("click", function() {
        ...
        if (document.getElementById("additionalInput").value.trim() !== "") {
            ...
            document.getElementById("comment").value = additionalData;
            // Submit the form
