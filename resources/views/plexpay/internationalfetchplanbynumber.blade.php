...
div.nav-dat {
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">International Plan Confirm</li>
  </ol>
</nav>
  ...
  <div class="col-sm-6">
    <div class="input-group">
      <div class="row">
        ...
        <input type="text" name="phone" value="+{{$dial_code}}"  style="height:56px;" class="form-control" placeholder="Phone Number with Country Code">
      </div>
      <span class="input-group-addon" style="padding: 10px 12px;" id="basic-addon2"><button class="btn btn-primary" type="submit">SUBMIT</button></span>
    </div>    
  </div>
</div>
</form>
