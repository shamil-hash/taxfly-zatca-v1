    ...
    <div id="content">
      ...
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active" aria-current="page">Voucher Recharge Confirm</li>
        </ol>
      </nav>
      ...
      <div align="container-fluid">
        <form action="/voucherrechargeconfirm/1" method="GET" style="margin-left :400px ">
          @csrf
          <div class="col-sm-5">
            <div class="panel panel-info"  align="center">
              <input type="hidden" value="{{$name}}" name="name">
              <input type="hidden" value="{{$voucher_id}}" name="voucher_id">
              <input type="hidden" value="{{$providerCode}}" name="providerCode">
              <input type="hidden" value="{{$mrp}}" name="mrp">
              <h4>Please confirm your recharge on</h4>&nbsp; <h3>{{$name}} e-voucher of AED {{$mrp}}</h3>
              <br><br>
              <div class="row">
                <a class="btn btn-primary btn-close" href='/plexpaybalance'>Cancel</a>&nbsp; &nbsp;
                <button class="btn btn-primary" type="submit" style="width:80px" >Confirm</button>
