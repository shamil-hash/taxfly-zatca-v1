...
div.nav-dat {
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">Local Custom Recharge</li>
  </ol>
</nav>
...
<br>
<ul class="nav nav-tabs nav-justified"><li role="presentation" class="active"><a href="/customrecharge/{{$carrier_code}}">CUSTOM</a></li></ul>
      ...
      <div class="col-sm-4"></div>
        <div class="col-sm-4">
          <div class="input-group">
            <input type="text" name="phone" class="form-control" placeholder="Enter the number without country code">
          ...
          <input type="hidden" name="ProviderName" value="1">
          <input type="hidden" name="ProviderName" value="1">
          <input type="hidden" name="Our_SendValue" value="1">
          <input type="hidden" name="SkuCode" value="1">
          <input type="hidden" name="SendValue" value="1">
          <input type="hidden" name="ReceiveValue" value="1">
          <input type="hidden" name="Country_Iso" value="1">
          <input type="hidden" name="ProviderCode" value="1">
          <input type="hidden" name="CoupenTitle" value="1">
          <input type="hidden" name="Expiry_Date" value="1">
          <input type="hidden" name="method" value="0">
          <input type="text" name="amount" class="form-control" placeholder="Recharge" style="width: 250px;"><br>
          <button type="submit" class="btn btn-primary">Recharge Now</button><br>
        </div>
      </div>
    </div>   
  </div>
